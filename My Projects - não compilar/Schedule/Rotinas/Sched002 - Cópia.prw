...
Private ASBACE    := ""
	...
	fPrintBol(oPrint,aDadosEmp,aDadosTit,aDadosBanco,aDatSacado,aBolText,aBolText1,aBolTextEXC,_cLinDig,_cCodBar,cNroDocRea; 
					, SE1->E1_VALJUR,SE1->E1_PORCJUR, SE1->E1_ACRESC ,SE1->E1_DECRESC)
