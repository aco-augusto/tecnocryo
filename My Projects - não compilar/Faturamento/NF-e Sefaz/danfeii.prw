...
oDanfe:Say(052,nMyCol, "Identificação do emitente",oFont12N:oFont)
nLinCalc	:=	065
...
For nX := 1 To nForTo
	...
	oDanfe:Say(nLinCalc,nMyCol,SubStr(cStrAux,Iif(nX==1,1,((nX-1)*25)+1),25), oFont11N:oFont )
	nLinCalc+=10
Next nX
...
For nX := 1 To nForTo
	...
	oDanfe:Say(nLinCalc,nMyCol,SubStr(cStrAux,Iif(nX==1,1,((nX-1)*40)+1),40),oFont08N:oFont)	
	nLinCalc+=10
Next nX
...
If Type("oEmitente:_EnderEmit:_xCpl") <> "U"
	...
	oDanfe:Say(nLinCalc,nMyCol, oEmitente:_EnderEmit:_xMun:Text+"/"+oEmitente:_EnderEmit:_UF:Text,oFont08N:oFont)	
	nLinCalc+=10
	//oDanfe:Say(nLinCalc,098, "Fone: "+IIf(Type("oEmitente:_EnderEmit:_Fone")=="U","",oEmitente:_EnderEmit:_Fone:Text),oFont08N:oFont)
	oDanfe:Say(nLinCalc,nMyCol, "Fone: "+IIf(Type("oEmitente:_EnderEmit:_Fone")=="U","",oEmitente:_EnderEmit:_Fone:Text),oFont08N:oFont)
Else
	...
	oDanfe:Say(nLinCalc,nMyCol, NoChar(oEmitente:_EnderEmit:_xBairro:Text,lConverte)+" Cep:"+TransForm(IIF(Type("oEmitente:_EnderEmit:_Cep")=="U","",oEmitente:_EnderEmit:_Cep:Text),"@r 99999-999"),oFont08N:oFont)
	nLinCalc+=10
	//oDanfe:Say(nLinCalc,098, oEmitente:_EnderEmit:_xMun:Text+"/"+oEmitente:_EnderEmit:_UF:Text,oFont08N:oFont)
	oDanfe:Say(nLinCalc,nMyCol, oEmitente:_EnderEmit:_xMun:Text+"/"+oEmitente:_EnderEmit:_UF:Text,oFont08N:oFont)
	nLinCalc+=10
...
If nfolha==1
	If lMv_Logod
		...
		oDanfe:SayBitmap(058,005,cLogoD,090 + 15, 090 - 072)		
	Else
		//oDanfe:SayBitmap(045,005,cLogo,090,090)
		oDanfe:SayBitmap(058,005,cLogo,090 + 15, 090 - 072)		
	EndIF
Endif
