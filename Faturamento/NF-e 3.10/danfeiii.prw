...
If len(oEmitente:_xNome:Text)>40
	oDanfe:Say(nLine+070,nBaseTxt,SubStr(NoChar(oEmitente:_xNome:Text,lConverte),1,40), oFont12N:oFont )
	oDanfe:Say(nLine+080,nBaseTxt,SubStr(NoChar(oEmitente:_xNome:Text,lConverte),41,40), oFont12N:oFont )
Else
...
If nfolha>=1
	If lMv_Logod
		...
		oDanfe:SayBitmap(020,075,cLogoD,095 + 040, 096 - 078)		
	Else
		//Tecnocryo
		//oDanfe:SayBitmap(005,075,cLogo,095,096)
		oDanfe:SayBitmap(020,075,cLogo,095 + 040, 096 - 078)		
	EndIf
Endif
