...
//		oDanfe:SayBitmap(045,001,cLogoD,080,090)
		oDanfe:SayBitmap(058,002,cLogoD,090 - 01, 090 - 072)
	Else
//		oDanfe:SayBitmap(045,001,cLogo,080,090)
		oDanfe:SayBitmap(058,002,cLogo,090 - 01, 090 - 072)	
	EndIF
Endif
...
For nY := 1 To nLenItens
	...
	//			oDanfe:SayBitmap(002+nLinhavers,003,cLogoD,085,085)
				oDanfe:SayBitmap(003+nLinhavers,005,cLogoD,090 - 01, 090 - 072)
			Else
//				oDanfe:SayBitmap(002+nLinhavers,003,cLogo,085,085)
				oDanfe:SayBitmap(003+nLinhavers,005,cLogo,090 - 01, 090 - 072)
			EndIf
	...
	If	nL > Iif( (nfolha-1)%2==0 .And. MV_PAR05==1,MAXITEMP3,nMaxItemP2)
		...
		If lMv_Logod
			oDanfe:SayBitmap(003,002,cLogoD,090 - 01, 090 - 072)
		Else
			oDanfe:SayBitmap(003,002,cLogo,090 - 01, 090 - 072)
		EndIf
	...
	Else
		...
		nAuxH2 := len(aAux[1][8][nY]) + (nAuxH + (aTamCol[8]) - RetTamTex(aAux[1][8][nY], oFont08:oFont, oDanfe)) - 3
...
If lMensagens
	...
	If lMv_Logod
		oDanfe:SayBitmap(000,000,cLogoD,090 - 01, 090 - 072)
	Else
		oDanfe:SayBitmap(000,000,cLogo,090 - 01, 090 - 072)
	EndIf
...
If nfolha==1
	If lMv_Logod
		oDanfe:SayBitmap(043,001,cLogoD,090 - 01, 090 - 072)
	Else
		oDanfe:SayBitmap(043,001,cLogo,090 - 01, 090 - 072)
	EndIF
Endif
